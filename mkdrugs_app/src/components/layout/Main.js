        ...
        >
          <defs>
            ...
            <g id="plane">
              ...
              <use className="helix" href="#helix" filter="url(#f1)"></use>
              <line
                fill="none"
                className="stroke"
                x1="728"
          ...
          <use className="box" href="#box" x="20" y="30"></use>
          <use className="parachute" href="#parachute" x="20" y="-112"></use>
          <rect fill="white" x="320" y="310" width="665" height="238"></rect>
          <use className="tshirt" href="#tshirt"></use>
          <use className="cap" href="#cap" y="-150"></use>
          <use className="ball" href="#ball" y="-140"></use>
          <use
          ...
          <use
            ...
            y="50"
          ></use>
          <use className="cloud" href="#cloud2" x="0" y="10"></use>
          <use className="plane" href="#plane" y="-80"></use>

          <use className="cloud2" href="#cloud" x="0" y="130"></use>
          <use className="trees" href="#tree" x="40" y="0"></use>
          <circle
            ...
            r="23"
          ></circle>
          <use className="cat" href="#cat" x="15" y="5"></use>
          <g id="browser">
            <path
              fill="none"
              className="stroke"
          ...
          <g id="toldo">
            ...
            />
            <use className="tol" href="#tol" x="-250"></use>
            <use className="tol" href="#tol" x="334"></use>
            <use className="tol" href="#tol" x="417"></use>
            <line
              className="stroke round-end"
              x1="277"
              y1="470.5"
          ...
          <use className="grass" href="#grass" x="130" y="0"></use>
          <rect
            className="grass"
            x="130"
            y="850"
